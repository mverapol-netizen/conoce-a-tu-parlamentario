  ...
  const render = (snapshot, commission, activitySnapshot, activity) => {
    ...
    root.innerHTML = `
      ...
      <section class="commission-section">
        ...
        <p class="commission-section-lead">La Cámara publica por separado lo que una comisión fue convocada a tratar y lo que luego registra como materia tratada o acuerdo. Mantener ambas capas separadas evita convertir una citación en una decisión.</p>
      ...
      <section class="commission-section">
        ...
        <p class="commission-section-lead">Las páginas oficiales permiten profundizar en sesiones, proyectos, citaciones y resultados. Todavía no reconstruimos en nuestra base todas las actas, audiencias, oficios, informes ni el historial completo de sesiones.</p>
        <div class="commission-links">
  ...
  const init = async () => {
    ...
    try {
      ...
      if (activityResponse.ok) {
        ...
        if (String(candidate.schema_version || '').startsWith('commission-activity-web-v0.2') && candidate.quality_gate?.passed === true) {
